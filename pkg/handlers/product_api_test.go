...
func TestProductAPI_GetAllProducts(t *testing.T) {
	gin.SetMode(gin.TestMode)
	t.Run("Success", func(t *testing.T) {
		products := []models.Product{{Name: "test-name", Price: 10, Description: "test-desc", Model: gorm.Model{ID: 1}}}
		mockApi := mocks.ProductAPI{}
...
func TestProductAPI_GetProductByID(t *testing.T) {
	gin.SetMode(gin.TestMode)
	t.Run("Success", func(t *testing.T) {
		product := models.Product{Name: "test-name", Price: 10, Description: "test-desc", Model: gorm.Model{ID: 1}}
		mockApi := mocks.ProductAPI{}
...
func TestProductAPI_AddProduct(t *testing.T) {
	gin.SetMode(gin.TestMode)
	t.Run("Success", func(t *testing.T) {
		product := models.Product{Name: "test-name", Price: 10, Description: "test-desc", Model: gorm.Model{ID: 1}}
		mockApi := mocks.ProductAPI{}
...
func TestProductAPI_UpdateProduct(t *testing.T) {
	gin.SetMode(gin.TestMode)
	t.Run("Success", func(t *testing.T) {
		product := models.Product{Name: "test-name", Price: 10, Description: "test-desc", Model: gorm.Model{ID: 1}}
		mockApi := mocks.ProductAPI{}
